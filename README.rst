...
This is a python module for username and passwords with hash functions,
...
| If you had a function called reverse and it took the reverse of a
  string,
...
| hsh_enter determines which type the raw string should be before it
  enters the hash function
| hsh_enter is default as bytes, but if your function took in a string,
