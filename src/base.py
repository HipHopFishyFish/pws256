class Validator:
    def __init__(self, hashed, hsh_func, hsh_enter, hsh_after, salt):
        self.hashed, self.__hsh_func, self.__hsh_enter, self.__hsh_after, self.__salt = hashed, hsh_func, hsh_enter, hsh_after, salt
    
    def hash_password_validator(self, raw):
        return hash_password(raw, self.__hsh_func, self.__hsh_enter, self.__hsh_after, self.__salt)
